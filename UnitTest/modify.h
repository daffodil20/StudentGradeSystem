...
void modify_score0(char* accountNamechar, char* PassWord, char* id, char* idx, double new_grade);
void modify_score1(char* PassWord, char* id, char* idx, double new_grade);
